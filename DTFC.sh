...
STARTUPCACHELOCATION = "Users/Username/Library/Caches/Firefox/Profiles/ngov24pu.default-release/startupCache/"
...
if [ ! -d $STARTUPCACHELOCATION ]; then
